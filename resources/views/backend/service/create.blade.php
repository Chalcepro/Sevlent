                    ...
                    <div class="card card-light">
                        ...
                        <div class="card-body pt-3 pb-0">
                            <div class="form-group">
                                ...
                                <input placeholder="Topic title here for seo..." type="text" class="form-control"
                        ...
                        <div class="card-body  pt-0 pb-0">
                            <div class="form-group">
                                ...
                                <textarea placeholder="Topic description here for seo..." class="form-control" name="meta_description" id=""
                        ...
                        <div class="card card-primary sticky-bottom">
                            ...
                            <div class="card-body pb-0">
                                <div class="form-group select2-dark">
                                    ...
                                    <small>&nbsp;&nbsp;Select category for Topic</small>
